                    ...
                    <div className="row align-items-lg-start justify-content-around" data-aos="fade-up">
                        <div className="col-md-6 mb-5 mb-md-0 p-4">
                            ...
                            <p className='text-justified'>
                                Karabük Teknokent Teknoloji Transfer Ofisi, Sanayi ve Teknoloji Bakanlığı tarafından 30.09.2017 tarihinde 30196 sayılı Resmî Gazete’de yayımlanarak Karabük Üniversitesi kampüsü içerisinde bulunan 15,023,20 m2 yüzölçümlü bir alanda kurulması ilan edilmiştir.
                            </p>
                            <p className='text-justified'>
                                Geri dönüşüm çalışmalarından Elektroniğe, yazılım geliştirmeden Makine ve Teçhizat imalatına, Enerji çalışmalarından demir imalatına gibi geniş bir faaliyet alanı bulunan Karabük Teknokent Teknoloji Transfer Ofisi toplam 41 firmasıyla çalışmalarını sürdürmektedir. Bunlardan 21 tanesi AR-GE firması, 20 tanesi kuluçka firmasıdır.
                            </p>
                            <p className='text-justified'>
                                Karabük Teknokent Teknoloji Transfer Ofisi, üniversite ve sanayi arasındaki iş birliği ve sinerji oluşumu ile katma değeri yüksek ürünlerde AR-GE çalışmalarının sürdürülmesi en öncelikli amacıdır. Üniversite bilgi birikimleriyle araştırma alt yapısının teknokent girişimcilerin faydalanmasını sağlayarak hem sanayi hem de akademik bakış açısı ile uluslararası ölçekte rekabetçi üstünlüğe sahip projeler üretmeyi hedeflemektedir.
                            </p>
